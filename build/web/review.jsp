...
<div class="w-full bg-white flex flex-col justify-center items-center">
    ...
    <div class="w-full flex justify-center my-3 p-8 ">
        <div class="w-[84%]">
            <h1 class="mb-2 font-bold">Leave Your Comment</h1>
            <form>
                <textarea required="required" placeholder="Enter your comment ..." class="px-4 py-2 border border-2 outline-none w-full"></textarea>
