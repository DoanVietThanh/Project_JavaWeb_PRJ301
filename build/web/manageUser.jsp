        ...
        <main class="main">
            <div class="pt-[80px] px-[20px]">
                <div class="flex justify-between items-center border-b-4 py-2">
                    ...
                    <form action="adminCreateUserPage">
                    ...
                    <form action="manageUserForm">
                        <label class="font-bold">Search User</label>
                ...
                <div>
                    <c:if test="${not empty requestScope.username_Bug}">
                        <div class="text-red-600">Account (${requestScope.username_Bug}) :</div>
                    </c:if>
                        ...
                        <table border="1" class="w-full ">
                            ...
                            <tbody>
                                <c:forEach items="${listAccount}" var="itemAccount" begin="1" varStatus="counter" >
                                    <tr 
                                        <c:if test="${itemAccount.username.equals(requestScope.username_Bug)}">
                                            class="bg-gray-300"
                                        </c:if>
                                        >
                                <form action="updateUserForm" class="p-8 my-2">
                                    ...
                                    <td class="">
                                        <input type="text" name="txtFullname" value="${itemAccount.fullname}" class="w-full text-center"/>
                                    </td>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="${delete}"><i class="fa fa-trash-alt"></i></a>
                                    </td>
                                    <td class="text-center">
                                        <input type="hidden" name="searchValue" value="${requestScope.searchUser}" />
