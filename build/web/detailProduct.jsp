    ...
    <body>
        ...
        <c:if test="${not empty requestScope.detailProduct}">
            ...
            <div class="w-[40%] border-2 p-8 font-bold bg-[#fff] flex flex-col gap-[20px]">
                ...
                <div>
                    <form action="">
                        Quantity <input type="number" required="required" min="0" placeholder="Enter number ..." class="border-2 p-2 outline-none"/> </br>
                        <h1 class="my-[30px] text-center">---------------------------------------</h1>
                        <input type="submit" value="Add To Cart" class="cursor-pointer p-2 bg-[#232f3e] text-white mt-[10px] px-10 w-[100%] rounded-lg hover:opacity-90"/>
                    </form>
                </div>
            </div>
        </div>
