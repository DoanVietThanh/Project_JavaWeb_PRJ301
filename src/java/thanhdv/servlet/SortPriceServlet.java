 ...
 * @author Oliver Doan
 */
@WebServlet(name = "SortPriceServlet", urlPatterns = {"/sortPrice"})
public class SortPriceServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String typePrice = request.getParameter("sortBy");
            ProductDAO daoProduct = new ProductDAO();
            List<ProductDTO> listProduct = daoProduct.sortProductByPrice(typePrice);
